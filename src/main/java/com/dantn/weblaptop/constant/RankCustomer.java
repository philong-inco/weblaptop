...
//    COPPER(0, "Đồng", new BigDecimal(0), BigDecimal.ZERO, new BigDecimal(1_000_000),0),
//    SILVER(1, "Bạc", new BigDecimal(0), new BigDecimal(1_000_001), new BigDecimal(5_000_000),5),
//    GOLD(2, "Vàng", new BigDecimal(0), new BigDecimal(5_000_001), new BigDecimal(10_000_000),10),
//    PLATINUM(3, "Bạch Kim", new BigDecimal(0), new BigDecimal(10_000_001), new BigDecimal(20_000_000),20),
//    DIAMOND(4, "Kim Cương", new BigDecimal(0), new BigDecimal(20_000_001), BigDecimal.valueOf(Long.MAX_VALUE),30);
//
